...
void DicomDetectorConstruction::ConstructPhantomContainer()
{
	...
	// wjcheon
	//Translation
	G4double CancerPositionX = 80.0*mm;
	G4double CancerPositionY = 0.0*mm;
	G4double CancerPositionZ = 0.0*mm;
	...
	G4ThreeVector posCentreVoxels(fOffsetX+CancerPositionX,fOffsetY+CancerPositionY,fOffsetZ+CancerPositionZ);
#ifdef G4VERBOSE
